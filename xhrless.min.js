...
typeof a&&a.length&&(a=document.querySelector(a));if("object"!=typeof a||!(a instanceof Element))throw Error("Invalid node element / CSS selector");this.isStatusOK()?a.innerHTML=this.xhr.responseText:a.innerHTML="function"==typeof d?d(this)||"":d||""}).send();return this},b.prototype.showPreloader=function(a){"string"==typeof a&&a.length&&(a=document.querySelector(a));"object"==typeof a&&a instanceof Element&&(a.innerHTML='<div class="xhr_preloader" id="xhr_preloader_'+a.id+'" style="height:'+a.clientHeight+
"px;width:"+a.clientWidth+'px;margin:0px;padding:0px;"></div>');return this});if(e)window[g]=b;else if(f)module.exports=b;else throw Error("Unsupported environment");})("XHR");
